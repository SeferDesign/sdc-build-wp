...
function TUIRoot({ tui }) {
	...
	const availableLogRows = Math.max(3, terminalRows - header.lineCount - promptLines.length - 4);
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				...
				React.createElement(Text, { key: 'header-title' }, header.titleLine),
...
class TUI {
	...
	getHeaderLayout(terminalColumns = 80) {
		...
		const topLineCount = urlLine
			...
			: getWrappedLineCount(titleLine, innerWidth);
